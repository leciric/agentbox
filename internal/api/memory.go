...
// conversation any one agent is having ([D72](../../docs/implementation/decisions.md#d72)).
...
// wrote, what it cost ([D76](../../docs/implementation/decisions.md#d76)).
...
// The context builder's surface ([D75](../../docs/implementation/decisions.md#d75)).
