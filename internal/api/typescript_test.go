...
var tsTypes = []any{
	...
	ClaudeTokenRequest{}, ClaudeLoginRequest{}, ClaudeLogin{}, ClaudeLoginCodeRequest{}, GitHubTokenRequest{},
	...
	Question{}, AskRequest{}, AnswerQuestionRequest{}, EscalateQuestionRequest{}, AgentEvent{},
	...
	ChatPermission{}, ChatPermissionOption{}, ChatSubagent{}, ChatCompaction{}, ChatTurnResult{}, ChatMessageRequest{}, ChatImage{}, ChatImageUpload{}, ChatAnswerRequest{}, ChatOptionRequest{}, ChatEvent{}, ChatAppend{}, ProjectChat{},
...
var tsConstants = [][2]string{
	...
	{"EventChat", EventChat}, {"EventQuestion", EventQuestion}, {"EventAgentEvent", EventAgentEvent},
