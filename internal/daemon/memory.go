...
// The project memory API ([D72](../../docs/implementation/decisions.md#d72)).
...
//     which is what decides the project ([D42](../../docs/implementation/decisions.md#d42)).
//   - /v1/self/memory/…               — an agent, on its own socket, which is
//     what decides both the project and the agent ([D17](../../docs/implementation/decisions.md#d17)).
//
