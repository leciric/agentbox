...
var migrations = []string{
	...
	// The project brain ([D72](../../docs/implementation/decisions.md#d72)),
	...
	// ([D73](../../docs/implementation/decisions.md#d73)), as a percentage of
	...
	// ([D75](../../docs/implementation/decisions.md#d75)). The default is
	...
	// Consolidation ([D76](../../docs/implementation/decisions.md#d76)): what
	...
	// Project state as a graph ([D77](../../docs/implementation/decisions.md#d77)):
	...
	// ([D78](../../docs/implementation/decisions.md#d78)). Reading a window of
	...
	// ([D79](../../docs/implementation/decisions.md#d79)): sections, which are
	...
	// ([D83](../../docs/implementation/decisions.md#d83)). One row per model a
	...
	// ([D85](../../docs/implementation/decisions.md#d85)): how much of the
...
// with everything else ([D72](../../docs/implementation/decisions.md#d72)).
...
// ([D45](../../docs/implementation/decisions.md#d45)), so a literal check would
