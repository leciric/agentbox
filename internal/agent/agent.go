...
//     ([D45](../../docs/implementation/decisions.md#d45)). A model the adapter
...
func agentMCPServers(home string) []mcpServer {
	return []mcpServer{
		...
		// ([D72](../../docs/implementation/decisions.md#d72)).
